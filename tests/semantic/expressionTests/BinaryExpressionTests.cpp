...
TEST(EXPR_BINARY, INT_DIVIDE) {
    ASSERT_SEMANTICALLY_VALID("float x = 5 / 5;");
}

TEST(EXPR_BINARY, INT_FLOAT_DIVIDE) {
    ASSERT_SEMANTICALLY_VALID("float x = 5 / 5.5f;");
}

TEST(EXPR_BINARY, FLOAT_INT_DIVIDE) {
    ASSERT_SEMANTICALLY_VALID("float x = 5.5f / 5;");
}

TEST(EXPR_BINARY, FLOAT_DIVIDE) {
    ASSERT_SEMANTICALLY_VALID("float x = 5.5f / 5.5f;");
}

TEST(EXPR_BINARY, INT_INTEGER_DIVISION) {
    ASSERT_SEMANTICALLY_VALID("int x = 5 // 5;");
}

TEST(EXPR_BINARY, INT_INT_MODULO) {
    ASSERT_SEMANTICALLY_VALID("int x = 5 % 5;");
}

TEST(EXPR_BINARY, FLOAT_INT_MODULO) {
    ASSERT_SEMANTICALLY_VALID("float x = 5.5f % 5;");
}

TEST(EXPR_BINARY, INT_FLOAT_MODULO) {
    ASSERT_SEMANTICALLY_VALID("float x = 5 % 5.5f;");
}

TEST(EXPR_BINARY, FLOAT_FLOAT_MODULO) {
    ASSERT_SEMANTICALLY_VALID("float x = 5.5f % 5.5f;");
}
...
TEST(EXPR_BINARY, INVALID_BOOL_DIVIDE) {
    ASSERT_THROWS_TYPE_ERROR("int x = false / 5.5f;");
}

TEST(EXPR_BINARY, INVALID_FLOAT_INTEGER_DIVISION) {
    ASSERT_THROWS_TYPE_ERROR("int x = 5 // 5.5f;");
}

TEST(EXPR_BINARY, INVALID_BOOL_INTEGER_DIVISION) {
    ASSERT_THROWS_TYPE_ERROR("int x = 5 // true;");
}

TEST(EXPR_BINARY, INVALID_BOOL_INT_MODULO) {
    ASSERT_THROWS_TYPE_ERROR("int x = true % 5;");
}
