...
| dup      | 0x04   | 3                  | `<immediate>`            | [x, ...] → [x, ..., x]                            | Duplicates the value `<immediate>` positions below the top of the operand stack.                                                                               |
| swap     | 0x05   | 1                  |                          | [x, y] → [y, x]                                   | Swaps the top two values of the operand stack.                                                                                                                 |
| rotD     | 0x06   | 3                  | `<immediate>`            | [a, b, ..., z] → [b, ..., z, a]                   | Rotates the top `<immediate>` values of the operand stack downwards by one position, moving the bottom of the rotated section to the top of the operand stack. |
| rotU     | 0x07   | 3                  | `<immediate>`            | [a, ..., y, z] → [z, a, ..., y]                   | Rotates the top `<immediate>` values of the operand stack upwards by one position, moving the top of the operand stack to the bottom of the rotated section.   |
